export type PermissionServices = {
	checkPermission: { data: PermissionState };
};

export type PermissionMachineState = 'initializing' | 'done' | 'busy' | 'idle' | 'ready';
...
// Notification
export type NotificationParameters = ConstructorParameters<typeof Notification>;

// Screen Wake Lock
// API-specific types borrowed from: https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/dom-screen-wake-lock
 ...
 * released.
 */
export type WakeLockSentinel = EventTarget & {
...
export type ScreenWakeLockOptions = {
	reaquireLockWhenVisible?: boolean;
	releaseOnLoad?: boolean;
};

export type ScreenWakeLockStates = 'initializing' | 'active' | 'released' | 'unsupported';
